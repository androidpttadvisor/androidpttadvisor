...
public class PTTNode {
	...
	public String pathToHeaderImage;
	...
	public PTTNode(int id, String question, ArrayList<PTTAnswer> answers, String pathToHeaderImage,
			ArrayList<String> footnotes) {
		super();
		this.id = id;
		this.question = question;
		this.answers = answers;
		this.pathToHeaderImage = pathToHeaderImage;
	...
	public String getPathToHeaderImage() {
		return pathToHeaderImage;
	}




	public void setPathToHeaderImage(String pathToHeaderImage) {
		this.pathToHeaderImage = pathToHeaderImage;
	}
